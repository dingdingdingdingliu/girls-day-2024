...
const cardData = [
  ...
  },
  {
    ...
    copyWrite:
      "社會審美戴著放大鏡檢視女性外貌，但是，對於符合主流審美的「漂亮女生」卻也不是真心肯定，而是藏著「貶低陰柔氣質」的邏輯，總能找到理由進行攻擊。外貌姣好的女孩更容易面對能力被低估、被性化、被蕩婦羞辱的危機，\n例如，「打扮那麼漂亮一定是花瓶」、「心思都在打扮了，成績怎麼會好」或是「穿那樣被騷擾活該」，這些評論忽略了把自己打理好是一種能力，美感與選擇的能力，也可以通往造型師、彩妝師、服裝設計等專業領域。",
  },
  {
    title: "勇於表現的女孩",
...
const footerCardData = [
  ...
  },
  {
    title: "性別職業隔離現象",
    copyWrite:
      "一間公司、一個產業的男女比例，可說明內部性別平等程度嗎？還要看部門跟職位分佈喔。\n性別職業隔離可以從「垂直」跟「水平」方面檢視，「垂直的」指同一產業內男性多受僱於高職位，女性多落在低職位，主因是培訓、升遷的機會不均；「水平的」指不同產業間有明顯男女人數落差，例如美容美髮業為女性，科技業多為男性，這跟科系分流互為因果。",
  },
  {
    title: "月經貧窮",
    copyWrite:
      "生理用品（如衛生棉、棉條）屬於生活必需品，但目前臺灣稅制使相關用品價格不俗，負擔不起的人面臨健康隱憂，女童更可能受到知識、生理用品、醫療資源不足的多重困境。\n世界銀行2021年統計發現全球約五億人口正經歷「月經貧窮」，據倡議組織小紅帽2021年的調查，臺灣有9%人曾陷入月經貧窮，現在，場所免費生理用品、學校落實性教育、媒體避免複製「月經污名」，都助於打破惡性循環。",
  },
  {
    title: "容貌焦慮",
    copyWrite:
...
export default function SectionVisionStory({ setDialogData }) {
